package com.zxr.scmall.user.bean;
...
public class UmsMember {
    ...
    private String city;
    private String job;
    private int personalizedSignature;
    ...
    public int getPersonalizedSignature() {
        return personalizedSignature;
    }

    public void setPersonalizedSignature(int personalizedSignature) {
